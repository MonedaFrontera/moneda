...
// Generated 20/11/2012 09:37:40 PM by Hibernate Tools 3.2.4.GA
 ...
 */
@Entity
@Table(name = "vistacuentasaldo", schema = "public")
public class Vistacuentasaldo implements java.io.Serializable {
	...
	@AttributeOverrides( {
			...
			@AttributeOverride(name = "saldo", column = @Column(name = "saldo", precision = 12)),
