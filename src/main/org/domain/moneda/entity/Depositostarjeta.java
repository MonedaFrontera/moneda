...
public class Depositostarjeta implements java.io.Serializable {
	...
	public Depositostarjeta(int consecutivo, Tarjeta tarjeta, Date fecha, Cuenta cuenta, 
			BigDecimal preciobolivar, Date fechamod, String usuariomod,
			BigDecimal valordeposito, String tipodep,
			String tipodebolivar, BigDecimal depositopesos, String asesor, 
			String promotor) {
		this.consecutivo = consecutivo;
		this.tarjeta = tarjeta;
		this.fecha = fecha;
	...
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "numcuenta", nullable = true)
	...
	@Column(name = "depositopesos", precision = 10)
